  ...
  return (
    <>
      ...
      <div className="albero">
        <svg
          role="img"
          aria-label="A shining Christmas Tree animated"
          className="mainSVG"
    ...
    C0,2.6,1.56,4,2,4s2-1.4,2-2.9C4,0.49,3.51,0,2.9,0z"
            ...
            >
              ...
              <stop offset="0.4" stop-color="#334673" />
              <stop offset="0.6" stop-color="#EDDDC4" />
              <stop offset="0.9" stop-color="#FEE8C7" />
      ...
      <div className="augurio">What is Christmas?</div>
      <br />
      <div className="mask">
        It is the tenderness of the past, courage for the present, and hope for
        the future.
      </div>
      <input id="audio" type="checkbox" className="play" />
      <label htmlFor="audio" title="Toggle audio">
        <svg viewBox="0 0 24 24" className="audio_icon">
      ...
      <audio className="xmas" muted playsInline autoPlay loop></audio>
      <svg className="wavysvg">
        <filter id="wavy">
          <feTurbulence
            x="0"
            y="0"
